...
/**
 * Api services for the `Btc` model.
 */
@Injectable()
export class BtcApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Btc` object.)
   * </em>
   */
   ...
   * </em>
   */
  public poolHashrate(customHeaders?: Function): Observable<any> {
  ...
  /**
   * Statistical information for btc registers.
   *
